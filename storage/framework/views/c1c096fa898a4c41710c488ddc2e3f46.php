...
<body>
    ...
    <?php else: ?>
        <span class="status-rejected"><?php echo e(strtolower($status)); ?></span>.
    <?php endif; ?>
    </p>
    ...
    <?php if($status === 'approved'): ?>
        ...
        <a href="<?php echo e(url(route('login'))); ?>" class="button">Log In Now</a>
    ...
    <div class="footer">
        <p>Best regards,<br>
        The HR Team</p>
        <p>© <?php echo e(date('Y')); ?> E-PDS. All rights reserved.</p>
        <p><small>This is an automated message. Please do not reply directly to this email.</small></p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/mail/signup-status.blade.php ENDPATH**/ ?>