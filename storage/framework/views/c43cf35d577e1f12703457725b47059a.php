...
<div x-data="{ isOpen: <?php echo e($collapsed ? 'false' : 'true'); ?> }" class="card border-0 shadow-sm mb-2">
    
    <div class="card-header bg-<?php echo e($badgeColor); ?> text-light py-3 cursor-pointer" @click="isOpen = !isOpen"
        role="button">
...
<?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/components/card.blade.php ENDPATH**/ ?>