...
<script>
    function trainingCategoriesChartData() {
                ...
                chart: {
                    ...
                    events: {
                        dataPointSelection: function(event, chartContext, config) {
                            ...
                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('downloadTrainingCategoryList', selectedCategory);
                        }
                    }
                },
        ...
        return {
            init() {
                initCategoriesChart(<?php echo json_encode($chartData, 15, 512) ?>);
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/livewire/admin/charts/training-categories.blade.php ENDPATH**/ ?>