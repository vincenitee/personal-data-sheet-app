<div class="table-responsive m-0">
    <table id="pds-table">
            ...
            <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < 7; $i++): ?>
                ...
                <tr>
                    <td colspan="5" class="text-center fw-bold text-nowrap">
                        <?php echo e(strtoupper(optional($eligibility)->career_service ?? '')); ?>

                    </td>
                    <td colspan="1" class="text-center fw-bold text-nowrap">
                        <?php echo e(optional($eligibility)->ratings ?? ''); ?>

                    </td>
                    <td colspan="2" class="text-center fw-bold text-nowrap">
                        <?php echo e(optional($eligibility)->exam_date ? \Carbon\Carbon::parse($eligibility->exam_date)->format('m/d/Y') : ''); ?>

                    </td>
                    <td colspan="2" class="text-center fw-bold text-nowrap">
                        <?php echo e(strtoupper(optional($eligibility)->exam_place ?? '')); ?>

                    </td>
                    <td colspan="1" class="text-center fw-bold text-nowrap">
                        <?php echo e(optional($eligibility)->license_number ?? ''); ?>

                    </td>
                    <td colspan="1" class="text-center fw-bold text-nowrap">
                        <?php echo e(optional($eligibility)->license_validity ? \Carbon\Carbon::parse($eligibility->license_validity)->format('m/d/Y') : ''); ?>
        ...
        <tbody class="table-body">
            ...
            <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < 26; $i++): ?>
                <?php
                ...
                <tr>
                            ...
                            <tbody class="border-0">
                                <tr>
                                    <td class="border-0 border-bottom-0 fw-bold text-center" style="width: 50%">
                                        <?php echo e(optional($experience)->date_from ? \Carbon\Carbon::parse($experience->date_from)->format('m/d/Y') : ''); ?>

                                    </td>
                                    <td class="border-top-0 border-end-0 border-bottom-0 fw-bold text-center"
                                        style="width: 50%">
                                        <?php echo e(optional($experience)->date_to ? \Carbon\Carbon::parse($experience->date_to)->format('m/d/Y') : ''); ?>
                    ...
                    <td colspan="5" class="text-center fw-bold">
                        <?php echo e(strtoupper(optional($experience)->position ?? '')); ?>

                    </td>
                    <td colspan="2" class="text-center fw-bold">
                        <?php echo e(strtoupper(optional($experience)->agency ?? '')); ?>

                    </td>
                    <td colspan="1" class="text-center fw-bold">
                        <?php echo e(optional($experience)->salary ?? ''); ?>

                    </td>
                    <td colspan="1" class="text-center fw-bold">
                        <?php echo e(optional($experience)->salary_grade ? $experience->salary_grade . '-' . optional($experience)->salary_step : ''); ?>

                    </td>
                    <td colspan="1" class="text-center fw-bold">
                        <?php echo e(optional($experience)->status ? ucwords(str_replace('_', ' ', $experience->status)) : ''); ?>

                    </td>
                    <td colspan="1" class="text-center fw-bold">
                        <?php echo e(optional($experience)->government_service ? 'Y' : ''); ?>
...
<?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/livewire/print/sections/c2.blade.php ENDPATH**/ ?>