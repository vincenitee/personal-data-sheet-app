    ...
    <div class="card-body p-3">
        <div class="d-flex justify-content-between align-items-center gap-3">
            ...
            <button
                ...
                <?php echo e($currentStep === 1 ? 'disabled' : ''); ?>
            ...
            <div class="d-none d-md-flex align-items-center gap-2">
                ...
                <small class="text-muted">Step <?php echo e($currentStep); ?> of <?php echo e(count($steps)); ?></small>
            </div>
            ...
            <div class="btn-group">
                ...
                <button
                    ...
                    type="button"
                    class="btn btn-sm btn-primary d-inline-flex align-items-center gap-2 <?php echo e($currentStep === count($steps) ? 'd-none' : ''); ?>"
                    wire:loading.attr="disabled"
                >
                    <span>Next</span>
                ...
                <button
                    ...
                    type="button"
                    class="btn btn-sm btn-success d-inline-flex align-items-center gap-2 <?php echo e($currentStep !== count($steps) ? 'd-none' : ''); ?>"
                    wire:loading.attr="disabled"
                >
                    <span>Submit</span>
                    <div wire:loading wire:target="incrementSteps" class="spinner-border spinner-border-sm" role="status">
...
<?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/livewire/employee/pds/form-navigation.blade.php ENDPATH**/ ?>