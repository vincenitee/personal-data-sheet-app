...
<body>
    ...
    <?php else: ?>
        <div class="revision-details">
            ...
            <p><?php echo e($revision_comments); ?></p>

            <?php if(!empty($revision_items)): ?>
                <ul>
                    <?php $__currentLoopData = $revision_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <a href="<?php echo e(url(route('employee.submission.logs'))); ?>" class="button">Edit Your Entry</a>
    ...
    <div class="footer">
        ...
        <p>© <?php echo e(date('Y')); ?> Company Name. All rights reserved.</p>
        <p><small>This is an automated message. Please do not reply directly to this email.</small></p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/mail/entry-status.blade.php ENDPATH**/ ?>