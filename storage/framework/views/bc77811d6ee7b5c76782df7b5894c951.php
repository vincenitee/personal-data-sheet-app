<div class="card card-body p-0 shadow border-0 overflow-hidden">
    <!--[if BLOCK]><![endif]--><?php if($pdsEntry): ?>
        ...
        <div class="bg-light border-bottom p-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('pds.print', $pdsEntry->id)); ?>" class="btn btn-primary px-3">
        ...
        <div class="bg-white sticky-top border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
            <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 fw-normal">
                <i class="bi bi-layers me-1"></i>Page <?php echo e($currentStep); ?> of 4
            </span>

            <ul class="pagination pagination-sm mb-0">
                <li class="page-item <?php echo e($currentStep === 1 ? 'active' : ''); ?>">
                ...
                <li class="page-item <?php echo e($currentStep === 2 ? 'active' : ''); ?>">
                ...
                <li class="page-item <?php echo e($currentStep === 3 ? 'active' : ''); ?>">
                ...
                <li class="page-item <?php echo e($currentStep === 4 ? 'active' : ''); ?>">
...
[$__name, $__params] = $__split('print.sections.c1', [
                            'pdsEntry' => $pdsEntry,
                        ]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1803849105-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('print.sections.c2', [
                            'pdsEntry' => $pdsEntry,
                        ]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1803849105-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('print.sections.c3', [
                            'pdsEntry' => $pdsEntry,
                        ]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1803849105-2', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('print.sections.c4', [
                            'pdsEntry' => $pdsEntry,
                        ]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1803849105-3', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="bg-light border-top p-3 d-flex justify-content-between align-items-center">
            <button type="button" class="btn btn-outline-secondary px-3 <?php echo e($currentStep === 1 ? 'disabled' : ''); ?>"
                wire:click="jumpToSection(<?php echo e($currentStep - 1); ?>)" wire:loading.attr="disabled"
                wire:target="jumpToSection(<?php echo e($currentStep - 1); ?>)" <?php echo e($currentStep === 1 ? 'disabled' : ''); ?>>
                <span wire:loading.remove wire:target="jumpToSection(<?php echo e($currentStep - 1); ?>)">
                    <i class="bi bi-arrow-left me-2"></i>Previous
                </span>
                <span wire:loading wire:target="jumpToSection(<?php echo e($currentStep - 1); ?>)">
                    <span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
                    Loading...
                </span>
            </button>

            <button type="button" class="btn btn-primary px-3 <?php echo e($currentStep === 4 ? 'disabled' : ''); ?>"
                wire:click="jumpToSection(<?php echo e($currentStep + 1); ?>)" wire:loading.attr="disabled"
                wire:target="jumpToSection(<?php echo e($currentStep + 1); ?>)" <?php echo e($currentStep === 4 ? 'disabled' : ''); ?>>
                <span wire:loading.remove wire:target="jumpToSection(<?php echo e($currentStep + 1); ?>)">
        ...
        <div class="p-5">
            <div class="text-center py-5">
                ...
                <div class="d-flex flex-column flex-md-row gap-3 justify-content-center">
                    <a href="<?php echo e(url(route('employee.submission.logs'))); ?>" class="btn btn-primary px-4">
                        <i class="bi bi-clipboard-check me-2"></i>Check Submission Status
                    </a>
                    <a href="<?php echo e(url(route('employee.pds.create'))); ?>" class="btn btn-outline-primary px-4">
...
<?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/livewire/employee/preview-entry.blade.php ENDPATH**/ ?>