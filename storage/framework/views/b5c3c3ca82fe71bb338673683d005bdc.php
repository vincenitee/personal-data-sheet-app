    ...
    <script>
        function jobPositionData() {
            ...
            function initChart(chartData) {
                ...
                const data = chartData || <?php echo json_encode($chartData, 15, 512) ?>;
                    ...
                    chart: {
                        ...
                        events: {
                            dataPointSelection: function(event, chartContext, config) {
                                ...
                                window.Livewire.find('<?php echo e($_instance->getId()); ?>').downloadPositionEmployeeList(position);
                            }
                        }
                    },
            ...
            return {
                init() {
                    ...
                    if (<?php echo json_encode($chartData, 15, 512) ?>.labels && <?php echo json_encode($chartData, 15, 512) ?>.labels.length > 0) {
                        initChart();
                    }
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/livewire/admin/charts/job-position-distribution.blade.php ENDPATH**/ ?>