...
<aside class="bg-dark text-white vh-100 position-sticky top-0 overflow-hidden position-relative"
    ...
    <ul class="nav flex-column gap-1 mt-3">
        <li class="nav-item <?php echo e(request()->is('employee/dashboard') ? 'active' : ''); ?>">
        ...
        <li class="nav-item <?php echo e(request()->is('employee/pds/create') ? 'active' : ''); ?>">
        ...
        <li class="nav-item <?php echo e(request()->is('print') ? 'active' : ''); ?>">
            <a wire:navigate.hover href="<?php echo e(url(route('print'))); ?>" class="nav-link text-white">
                <i class="bi bi-file-plus me-1" style="font-size: 1.1rem;"></i>
                Print My Entry</a>
        </li>
        <li class="nav-item <?php echo e(request()->is('employee/submission-logs') ? 'active' : ''); ?>">
        ...
        <li class="nav-item <?php echo e(request()->is('employee/notification') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\personal-data-sheet-app\resources\views/partials/employee/sidebar.blade.php ENDPATH**/ ?>