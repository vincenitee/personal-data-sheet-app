...
<nav class="navbar py-3 navbar-expand-lg bg-white shadow-sm border border-bottom position-sticky top-0"
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex gap-2 align-items-start">
            ...
            <a wire:navigate href="<?php echo e(url(route('employee.notification'))); ?>" type="button" class="my-auto btn btn-sm position-relative">
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="max-width: 150px;">
                    <li class="dropdown-item-text">
                        <div class="text-truncate" style="max-width: 100%;">
                            <span class="d-block"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></span>
                            <small
                                class="d-block text-muted text-truncate"><?php echo e(auth()->user()->email); ?></small>
                        </div>
                    </li>
                    <li>
