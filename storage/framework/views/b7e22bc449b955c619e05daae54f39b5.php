        ...
        <table id="pds-table">
            ...
            <tbody class="table-body">
                ...
                <tr>
                    ...
                    <td colspan="11"><?php echo e($personalInformation->last_name ?? 'N/A'); ?></td>
                </tr>
                <tr>
                    <td colspan="1" class="s-label border-0">
                        <span class="count"></span> FIRST NAME
                    </td>
                    <td colspan="9"><?php echo e($personalInformation->first_name ?? 'N/A'); ?></td>
                    <td colspan="2" class="align-top">
                        <small><?php echo e($personalInformation->suffix ?? 'N/A'); ?>)</small>
                    </td>
                </tr>
                <tr>
                    <td colspan="1" class="s-label border-0">
                    ...
                    <td colspan="11"><?php echo e($personalInformation->middle_name ?? 'N/A'); ?></td>
                </tr>
                <tr>
                    <td colspan="1" class="s-label border-bottom-0">
                ...
                <tr>
                    ...
                    <td colspan="5"><?php echo e($personalInformation->birth_place ?? 'N/A'); ?></td>
                    <td colspan="3" class="s-label align-top border-0 text-center small">
                ...
                <tr>
                    ...
                    <td colspan="5"><?php echo e($personalInformation->sex ? ucwords($personalInformation->sex) : 'N/A'); ?></td>
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <?php echo e($personalInformation->civil_status ? ucwords($personalInformation->civil_status) : 'N/A'); ?>
                ...
                <tr>
                    ...
                    <td colspan="5"><?php echo e($personalInformation->height ?? 'N/A'); ?>m</td>
                    <td colspan="2" class="s-label align-top border-0"></td>
                    <td colspan="2"></td>
                </tr>
                <tr>
                    ...
                    <td colspan="5"><?php echo e((int) $personalInformation->weight ?? 'N/A'); ?>kg</td>
                ...
                <tr>
                    ...
                    <td colspan="5"><?php echo e($personalInformation->blood_type ?? 'N/A'); ?></td>
                ...
                <tr>
                    ...
                    <td colspan="4"><?php echo e($personalInformation->telephone_no ?? 'N/A'); ?></td>
                </tr>
                <tr>
                    <td colspan="1" class="s-label">
                    ...
                    <td colspan="4"><?php echo e($personalInformation->mobile_no ?? 'N/A'); ?></td>
                </tr>
                <tr>
                    <td colspan="1" class="s-label">
                    ...
                    <td colspan="4"><?php echo e($personalInformation->email ?? 'N/A'); ?></td>
                </tr>
            </tbody>
