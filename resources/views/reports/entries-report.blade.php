                        ...
                        <td>
                            @switch($key)
                                ...
                                @case('salary')
                                    ...
                                    @endphp
                                    {{ $salary ? 'P' . number_format($salary, 2) : 'N/A' }}
                                    @break
                                ...
                                @case('sex')
                                    {{ $entry?->personalInformation?->sex ? ucwords($entry->personalInformation->sex) : 'N/A' }}
                                    @break
                                ...
                                @case('employment_status')
                                    ...
                                    @endphp
                                    {{ $workType ? Str::title(str_replace('_', ' ', $workType)) : 'N/A' }}
                                    @break
