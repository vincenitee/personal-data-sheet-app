                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($temporaryLogo)
                                                    <img src="{{ $temporaryLogo }}" alt="New Logo"
                                                ...
                                                <div class="dropzone-content text-center p-4">
                                                    ...
                                                    @if ($newLogo)
                                                        <div class="mt-3 alert alert-success py-2">
                                                            ...
                                                            File selected: {{ $newLogo->getClientOriginalName() }}
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="card border p-4">
                                ...
                                <div class="mt-4 pt-3 border-top">
                                    ...
                                    <div class="d-flex border rounded overflow-hidden" style="height: 200px;">
                                        <!-- Sidebar Preview -->
                                        <div class="sidebar-preview-large text-white p-3 bg-{{ $sidebarColor }} bg-gradient"
                                            ...
                                            <div
                                                ...
                                                <div class="bg-{{ $sidebarColor }} bg-opacity-25 rounded p-2">
...
@push('scripts')
    <script>
        document.addEventListener('livewire:initialized', () => {
            ...
            updateSidebarPreview('@this.sidebarColor');
