        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-primary ms-2" href="{{ url(route('login')) }}" wire:navigate.hover>Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="hero-section" id="home">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center gap-3">
                <a href="{{ url(route('register')) }}" class="btn btn-primary btn-lg px-4" wire:navigate.hover><i
                        class="bi bi-person-plus me-2"></i>Get Started</a>
                <a href="{{ url(route('login')) }}" class="btn btn-outline-light btn-lg px-4" wire:navigate.hover><i
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <div class="mt-4">
                        <a href="{{ url(route('register')) }}" class="btn btn-primary" wire:navigate.hover><i
        ...
        <div class="container">
            <div class="row">
                ...
                {{-- <div class="col-md-3">
                    <h5>Legal</h5>
                    <ul class="list-unstyled">
                        <li><a href="#" class="text-decoration-none text-light"><i
                                    class="bi bi-shield me-2"></i>Privacy Policy</a></li>
                        <li><a href="#" class="text-decoration-none text-light"><i
                                    class="bi bi-file-text me-2"></i>Terms of Service</a></li>
                    </ul>
                </div> --}}
            </div>
            <hr class="my-4">
