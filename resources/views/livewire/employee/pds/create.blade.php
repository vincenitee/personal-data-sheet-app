<div>
    <div class="row g-2">
        {{-- Form Sections --}}
        @if (in_array($status, [null, 'draft', 'needs_revision', 'approved']))
            <div class="col-lg-3">
                    ...
                    <div class="d-flex flex-column flex-md-row">
                        ...
                        <div class="d-flex flex-column align-items-start align-items-md-end ms-md-auto mt-3 mt-md-0">
                            ...
                            <div class="d-flex flex-column btn-lg-group gap-2 align-self-center w-100">
                                <a href="{{ url(route('employee.submission.logs')) }}" class="btn btn-sm btn-primary w-100">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="commentsOffcanvas"
            ...
            <div class="offcanvas-header">
                <h6 class="offcanvas-title" id="offcanvasRightLabel">
                    Revision Comments <span class="ms-2 badge bg-primary rounded-pill">{{ $comments->count() }}</span>
                </h6>
