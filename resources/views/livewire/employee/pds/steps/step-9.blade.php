...
<div class="card card-body mb-2 d-flex flex-column gap-3">
    {{-- 34 --}}
    <x-employee.questionnaire.questions.consanguinity />

    {{-- 35(A)--}}
    <x-employee.questionnaire.questions.admin-offense />

    {{-- 35(B) --}}
    <x-employee.questionnaire.questions.criminal-charges />
