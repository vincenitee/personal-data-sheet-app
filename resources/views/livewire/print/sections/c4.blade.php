    ...
    <table id="pds-table">
        ...
        <tbody class="table-body question-block">
                    ...
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox"
                                    {{ $questions->has_third_degree_relative === $value ? 'checked' : '' }} disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
                    </div>
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox"
                                    {{ $questions->has_fourth_degree_relative === $value ? 'checked' : '' }} disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
                    </div>
            ...
            <tr>
                ...
                <td colspan="5" class="fw-bold text-center text-uppercase">
                    @if ($questions->fourth_degree_relative)
                        {{ $questions->fourth_degree_relative }}
                    @endif
                </td>
            </tr>
        </tbody>
        ...
        <tbody class="table-body question-block">
            <tr>
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox" {{ $questions->has_admin_case === $value ? 'checked' : '' }}
                                    disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
            ...
            <tr>
                <td colspan="7" class="s-label"></td>
                <td colspan="5" class="fw-bold text-center text-uppercase">
                    @if ($questions->admin_case_details)
                        {{ $questions->admin_case_details }}
                    @endif
                </td>
            </tr>
            <tr>
        ...
        <tbody class="table-body question-block">
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox"
                                    {{ $questions->has_criminal_conviction === $value ? 'checked' : '' }} disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
                    </div>
            ...
            <tr>
                ...
                <td colspan="5" class="text-uppercase fw-bold">
                    @if ($questions->criminal_conviction_details)
                        {{ $questions->criminal_conviction_details }}
                    @endif
                </td>
            </tr>
        </tbody>
        ...
        <tbody class="table-body question-block">
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox"
                                    {{ $questions->has_separation_from_service === $value ? 'checked' : '' }} disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
                    </div>
            ...
            <tr>
                ...
                <td colspan="2" class="text-uppercase fw-bold">
                    @if ($questions->separation_details)
                        {{ $questions->separation_details }}
                    @endif
                </td>
                <td colspan="3"></td>
            </tr>
        ...
        <tbody class="table-body question-block">
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox"
                                    {{ $questions->is_election_candidate === $value ? 'checked' : '' }} disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
                    </div>
            ...
            <tr>
                ...
                <td colspan="2">If YES, give details:</td>
                <td colspan="3" class="text-uppercase fw-bold">
                    @if ($questions->election_details)
                        {{ $questions->election_details }}
                    @endif
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox"
                                    {{ $questions->has_resigned_for_election === $value ? 'checked' : '' }} disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
                    </div>
            ...
            <tr>
                <td colspan="7" class="s-label"></td>
                <td colspan="2" class="text-uppercase fw-bold">
                    @if ($questions->resignation_details)
                        {{ $questions->resignation_details }}
                    @endif
                </td>
                <td colspan="3"></td>
            </tr>
        ...
        <tbody class="table-body question-block">
            <tr>
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox" {{ $questions->is_immigrant === $value ? 'checked' : '' }}
                                    disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
            ...
            <tr>
                <td colspan="7" class="s-label"></td>
                <td colspan="2" class="text-uppercase fw-bold">
                    @if ($questions->immigrant_country)
                        {{ $questions->immigrant_country }}
                    @endif
                </td>
                <td colspan="3"></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox" {{ $questions->is_indigenous === $value ? 'checked' : '' }}
                                    disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
            ...
            <tr>
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox" {{ $questions->is_disabled === $value ? 'checked' : '' }}
                                    disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
            ...
            <tr>
                ...
                <td colspan="2">
                    <div class="d-flex align-items-center gap-4">
                        @foreach ([1 => 'YES', 0 => 'NO'] as $value => $label)
                            <div class="d-flex align-items-center gap-2">
                                <input type="checkbox" {{ $questions->is_solo_parent === $value ? 'checked' : '' }}
                                    disabled>
                                <label>{{ $label }}</label>
                            </div>
                        @endforeach
            ...
            <tr>
                ...
                <td colspan="4" rowspan="6" class="p-5 border-bottom-0">
                    <div class="d-flex justify-content-center">
                        <img src="{{ optional($attachment)->passport_photo ? Storage::url($attachment->passport_photo) : asset('images/default-passport.png') }}"
                            alt="Passport Photo"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 30%">Government Issued ID: <strong
                                                        class="text-uppercase">{{ optional($attachment)->government_id_type ? str_replace('_', ' ', $attachment->government_id_type) : '' }}</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 30%">ID/License/Passport No.: <strong
                                                        class="text-uppercase">{{ optional($attachment)->government_id_no ?? '' }}</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 30%">Date/Place of Issuance: <strong
                                                        class="text-uppercase">{{ optional($attachment)->date_of_issuance ? \Carbon\Carbon::parse($attachment->date_of_issuance)->format('Y-m-d') : '' }}</strong>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody class="border-0">
                                            <tr>
                                                <td class="text-center p-1">
                                                    <img src="{{ optional($attachment)->right_thumbmark_photo ? Storage::url($attachment->right_thumbmark_photo) : '' }}" alt="" style="width: 100px; height: 100px; object-fit: contain;">
                                                </td>
                                            </tr>
                                            <tr>
